...
const ColorSwitcher = ({
  ...
  return (
    <PanelBody title={__("Color Settings", "wp-block-boilerplate")}>
      <ColorPalette
        colors={colorData}
        value={value}
      ...
      <ToolbarItem>
        {() => (
          <ToolbarDropdownMenu
            ...
            label={__("Select a Color", "wp-block-boilerplate")}
...
const BorderColorPicker = ({
  ...
  return (
    <PanelBody
      title={__("Border Settings", "wp-block-boilerplate")}
      initialOpen={false}
    >
...
const standardColorData = [
  {
    color: "#04316A",
    slug: "",
    name: __("Central institution", "wp-block-boilerplate"),
  },
  {
    color: "#C50F3C",
    slug: "rw",
    name: __("Faculty of Business, Economics, and Law", "wp-block-boilerplate"),
  },
  {
    color: "#7bb725",
    slug: "nat",
    name: __("Faculty of Sciences", "wp-block-boilerplate"),
  },
  {
    color: "#18B4F1",
    slug: "med",
    name: __("Faculty of Medicine", "wp-block-boilerplate"),
  },
  {
    color: "#FDB735",
    slug: "phil",
  ...
  },
  {
    color: "#8C9FB1",
    slug: "tf",
    name: __("Faculty of Engineering", "wp-block-boilerplate"),
  },
];
...
const extendedColorData: { color: string; slug: string; name: string }[] = [
  {
    color: "#fff",
    slug: "inherit",
    name: __("Inherit color", "wp-block-boilerplate"),
  },
  ...standardColorData,
];
